...
public class CustomerDAOImpl implements CustomerDAO {
  ...
  private EntityManagerFactory entityManagerFactory = PersistenceListener.getEntityManager();
	...
	@Override
	public RoomBookingCustomer getRoomBookingCustomerByPh(String ph, String storeId)
			throws DAOException {

		RoomBookingCustomer cust = null;
		EntityManager em = null;
		
		try {
			em = entityManagerFactory.createEntityManager();
			em.getTransaction().begin();
			TypedQuery<RoomBookingCustomer> qry = em
					.createQuery("SELECT c FROM RoomBookingCustomer c WHERE c.phone=:ph and c.store_id=:storeId and c.deleteflag='N'",
					    RoomBookingCustomer.class);
			qry.setParameter("ph", ph);
			qry.setParameter("storeId", storeId);
