...
import com.sharobi.restaurantapp.dao.OrdersDAO;
import com.sharobi.restaurantapp.dao.OrdersDAOImpl;
...
public class OrderService {
  ...
  @Autowired
	...
	public List<UniqueIdTypeMaster> getUniqueIdTypeByStore(Integer storeid) throws ServiceException {

		List<UniqueIdTypeMaster> orderTypLst = null;
		try {
			// get list of all order Types
			orderTypLst = ordersDAO.getUniqueIdTypeByStore(storeid);
		} catch (DAOException e) {
			e.printStackTrace();
			throw new ServiceException(
					"Problem occured while trying to get unique id types", e);
		}
		return orderTypLst;
	}
